        ...
        <nav id="top" className="container navbar navbar-expand-lg navbar-white bg-white my-md-4" >
            ...
            <ul className="navbar-nav ml-auto">
                <li className="nav-item ml-auto mr-md-2 my-1" >
                    {language === "fr" && (
                        <button
                            className="btn btn-bj-outline-custom rounded-pill" style={{ height:"100%", width:"50px",backgroundPosition:"center",backgroundImage: `url("http://localhost:3000/img/uk.png")` }} onClick={selectedLang}>
                        </button>
                    )}
