        ...
        <Fragment>
            ...
            <div className="col-12 col-md-9 text-center mx-auto my-5">
                <div className="col-11 col-md-6 mx-auto ">
                    <h2 className="mb-4 mb-md-3">Start a project together?</h2>
                    <p>If my profile matches your needs, do not hesitate to contact me for an interview in physics, in your premises or on video.</p>
