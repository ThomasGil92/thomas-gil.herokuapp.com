...
const Footer = () => {
    ...
    const footerLink = (fa, link) => {
        return (
            <a className="btn btn-outline-light rounded-circle m-2 p-3" href={link}><i className={fa + " d-flex justify-content-center align-items-center"} style={{ width: "25px", height: "25px" }}></i></a>
        ...
        <div
            ...
            <div className="row justify-content-center">
                <div className="col-12">
                    ...
                    <Link className="btn btn-outline-light rounded-circle m-2 p-3 " to={"/contact"}><i className="far fa-envelope d-flex justify-content-center align-items-center" style={{ width: "25px", height: "25px" }}></i></Link>
                </div>
            </div>
        </div>
    )
